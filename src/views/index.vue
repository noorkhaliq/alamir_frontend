<template>
    <main id="content" class="content" >
      ...
      <section
          class="MainSlider " style="height: 100vh">
        <div class="slider-bg-curve">
        <img src="/front/amirimages/slide-1.jpg" alt="">
      </div>
      <div class="container">
        <div class="MainMessage"  data-ca-options='{ "triggerHandler":"inview", "animationTarget":"all-childs", "duration":"1500", "delay":"600", "easing":"easeOutQuint", "direction":"forward", "initValues":{"translateY":-60, "opacity":0}, "animations":{"translateY":0, "opacity":1} }'>
          <div>
              ...
              <div class="box bg-white box-shadow-1 p-3 round" >
                ...
                <div class="text-center">
                  <ul class="inline-nav thumbs-img">
                    <li><a href="/front/amirimages/honoring/amir-honoring-1.jpg" class="fresco" data-fresco-group="honoring"><img class="thumb-img" src="/front/amirimages/honoring/amir-honoring-1-thumb.jpg"></a></li>
                    <li><a href="/front/amirimages/honoring/amir-honoring-2.jpg" class="fresco" data-fresco-group="honoring"><img class="thumb-img" src="/front/amirimages/honoring/amir-honoring-2-thumb.jpg"></a></li>
                    <li><a href="/front/amirimages/honoring/amir-honoring-3.jpg" class="fresco" data-fresco-group="honoring"><img class="thumb-img" src="/front/amirimages/honoring/amir-honoring-3-thumb.jpg"></a></li>
                    <li><a href="/front/amirimages/honoring/amir-honoring-4.jpg" class="fresco" data-fresco-group="honoring"><img class="thumb-img" src="/front/amirimages/honoring/amir-honoring-4-thumb.jpg"></a></li>
                  </ul>
                </div>
      ...
      <section class="bg-light pt-70 pb-70 z-9" id="OurService">
        <div class="container" >
          ...
          <div>
            <div class="col-md-6" v-for="item in getServices" :key="item.id">
              <div class="fancy-box fancy-icon-box fancy-box-case-study" data-hover3d="true">
                <div  class="iconbox iconbox-side iconbox-round iconbox-shadow iconbox-heading-sm iconbox-filled iconbox-filled  iconbox-has-fill-element" data-stacking-factor="1"  >
                  ...
                  <div class="contents">
                    <h3 class="font-weight-semibold font-size-22 mt-0 mb-10 color-primary">{{item.title}}</h3>
        ...
        <div class="container" >
          ...
          <div class=" carousel-container carousel-nav-floated carousel-nav-center carousel-nav-middle carousel-nav-md carousel-nav-solid carousel-nav-rectangle carousel-nav-shadowed carousel-dots-style1">
            <div  class="carousel-items row mx-0"
                  data-lqd-flickity='{"cellAlign":"center","prevNextButtons":true,"buttonsAppendTo":"self","pageDots":false,
                  "groupCells":true,"wrapAround":true,"pauseAutoPlayOnHover":false,"navArrow":"1","navOffsets":{"nav":{"top":"25%"}
                  ,"prev":"-13px","next":"-13px"}}'>

              <div class=" col-sm-6 col-md-3 px-2"  v-for="item in getIndexBlogs" :key="item.id">
                <div class="fancy-box content-box-heading-sm fancy-box-tour" >
                  <a href="#" class="fancy-box-image loaded">
                    <img v-show="item.image" :src="item.image" alt="هنا عنوان المقال">
                  </a>
                  <div class="fancy-box-contents">
                    <a href="#" class="d-block mb-3">
                      <h3 class="font-weight-semibold">{{item.title}}</h3>
                    </a><!-- /.fancy-box-header -->
                  ...
                  <div class="fancy-box-footer">
                    <span><i class="icon-basic_calendar"></i> {{item.registration_date}}</span>
      ...
      <section id="about"
               class="vc_row fullheight d-flex flex-wrap align-items-center bg-cover bg-center py-5 lqd-css-sticky"
                data-animate-from='{"opacity":1, "translateY": 0}' data-animate-to='{"opacity":1, "translateY": -200}' style="background-image: url(/front/amirimages/alamir-3.jpg);">

        <div class="liquid-row-overlay bg-fade-dark-05"></div>

        <div class="side-Message col-md-6">
          <div class="side-Message-inner">
            <div data-ca-options='{"triggerHandler":"inview","animationTarget":"all-childs","duration":1200,
            "delay":160,"initValues":{"translateY":50,"opacity":0},}'>
        ...
        <div class="container" >
          ...
          <div class="liquid-portfolio-list text-center" >
            ...
            <ul class="filter-list filter-list-inline size-md " id="Amir-portdolio">
              <li class="active" data-filter="*"><a>جميع المشاريع</a></li>

              <li v-for="item in getCategory" :key="item.id" class="list-group-item " :data-filter="'.category__'+item.id">
                {{item.category_title}}
              </li>
            </ul>
            ...
            <div class="row liquid-portfolio-list-row mt-30" data-liquid-masonry="true" data-masonry-options='{ "filtersID": "#Amir-portdolio" }'>
              ...
              <div v-for="item in getIndexProjects "
                   :key="item.id"  :class="'lqd-column col-lg-3 col-xs-6 masonry-item interior category__'+ item.category_id" >
                <div  class="ld-pf-item ld-pf-light pf-details-inside pf-details-boxed pf-details-circle
                pf-details-pull-down pf-details-pull-left title-size-18 pf-details-h-str pf-details-v-end pf-
                contents-mid pf-hover-masktext">
                  <div class="ld-pf-inner">
                    <div class="ld-pf-image">
                      <figure :style="'background-image:url('+(item.image ? item.image : '/front/amirimages/profile/villa/2.jpg')+')'">
                    ...
                    <div class="ld-pf-details " >
                      ...
                      <div class=" ld-pf-details-inner justify-content-center" data-custom-animations="true" data-ca-options='{ "triggerHandler": "mouseenter", "triggerTarget": ".ld-pf-item", "triggerRelation": "closest", "offTriggerHandler": "mouseleave", "animationTarget": ".split-inner", "startDelay": 200, "duration": 650, "delay": 150, "initValues": { "translateY": "100%" }, "animations": { "translateY": "0", "rotateX": 0 } }'>
                        <h5 class="ld-pf-title mb-0"  data-split-options='{ "type": "lines" }'>{{item.title}}</h5>
                        <div class="ld-pf-category size-md"  data-split-options='{ "type": "lines" }'>
                          <span class="d-block strong6">{{item.location}}</span>
                          <span class="d-block strong6">{{item.area}}</span>
                        </div>
                      </div>
                    </div>
<!--                    <a href="/front/amirimages/profile/villa/1.jpg" class="liquid-overlay-link fresco" data-fresco-group="profile" data-fresco-caption="المساحة: ٢٣٣ م - الموقع - النوع"></a>-->
                  </div>
                </div><!-- /.ld-pf-item -->
              </div>
      ...
      <section id="contact" class="vc_row bg-cover bg-center pt-60 pb-50 " data-parallax="true" data-parallax-options='{"parallaxBG": true}' style="background-image: url(/front/amirimages/bg-1.jpg);">
...
export default {
  ...
  mounted() {
    ...
    this.$store.dispatch('fetchIndexBlogs' );
    this.$store.dispatch('fetchCategory' );
    this.$store.dispatch('fetchIndexProjects' );
  },
  computed: {
    ...mapGetters([ 'getIndexBlogs' , 'getServices','getIndexProjects' , 'getCategory']),
  },
